interface CommandHandler{
   ...
   event void setAppClient(uint16_t destination, uint8_t srcPort, uint8_t destPort);
   event void appClientSend(uint16_t destination, uint8_t srcPort, uint8_t destPort, uint8_t * message);
}
